...
public class UserRequest {
	...
	public UserRequest reqFg(String val) {
		reqFg=val;
		return this;
	}
	
	public UserRequest mbrFg(int val) {
		mbrFg=val;
		return this;
	}
	
	public UserRequest mbrId(String val) {
		mbrId=val;
		return this;
	}
	
	public UserRequest ci(String val) {
		ci=val;
		return this;
	}
	
	public UserRequest corpUser(CorpUser corpUser) {
		this.corpUser=corpUser;
		return this;
	}
	
	public UserRequest busiUser(BusiUser busiUser) {
		this.busiUser=busiUser;
		return this;
	}
